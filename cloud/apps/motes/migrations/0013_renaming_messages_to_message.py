...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'motes_sighting', 'messages', 'message')

    def backwards(self, orm):
        db.rename_column(u'motes_sighting', 'message', 'messages')
    ...
    models = {
        ...
        u'motes.mote': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'786ce2b52d1342a5af65f819c3895159'", 'max_length': '255'})
        },
        u'motes.sighting': {
            ...
            'mote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['motes.Mote']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'43ff1ef82bc242038ab1609b56664d3e'", 'max_length': '255'})
        }
    }
